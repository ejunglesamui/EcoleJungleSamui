...
// @region namespaceDeclaration// @startlock
	var menuItem33 = {};	// @menuItem
	var menuItem32 = {};	// @menuItem
...
// eventHandlers// @lock
	...
	menuItem33.click = function menuItem33_click (event)// @startlock
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/Apropos.waComponent");
	};// @lock

	menuItem32.click = function menuItem32_click (event)// @startlock
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/Relances.waComponent");
	};// @lock
	...
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/GestNotes.waComponent");
	};// @lock

	menuItem29.click = function menuItem29_click (event)// @startlock
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/EvtFact.waComponent");
	};// @lock

	menuItem28.click = function menuItem28_click (event)// @startlock
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/Factures.waComponent");
	};// @lock

	menuItem27.click = function menuItem27_click (event)// @startlock
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/Paiements.waComponent");
	};// @lock
	...
	menuItem24.click = function menuItem24_click (event)// @startlock
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/FicheEleve.waComponent");
	};// @lock
	...
	{// @endlock
		$$("cchg").show();
		$$('component1').loadComponent("/PlanningMatieres.waComponent");
	};// @lock
...
// @region eventManager// @startlock
	WAF.addListener("menuItem33", "click", menuItem33.click, "WAF");
	WAF.addListener("menuItem32", "click", menuItem32.click, "WAF");
	...
	WAF.addListener("menuItem24", "click", menuItem24.click, "WAF");
